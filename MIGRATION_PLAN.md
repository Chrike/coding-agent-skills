...
| Ship | `deprecation-and-migration` | 合并/协调重叠 | P0 | 已确认，阶段 4 实现完成；聚焦验证与独立提交待完成 |
| Ship | `documentation-and-adrs` | 合并/协调重叠 | P0 | 已确认 |
| Ship | `observability-and-instrumentation` | 新增/改写引入 | P0 | 已确认 |
