...
description: Leaf alternative-generation worker for one controller-assigned design, plan, optimization, or implementation question where a materially different approach could change the outcome. Use only with supplied constraints and an independence contract; do not use for cosmetic variants, implementation, final selection, or autonomous orchestration.
model: inherit
