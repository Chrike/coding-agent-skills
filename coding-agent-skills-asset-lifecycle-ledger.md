...
| `playbook.plan-work` | `skills/plan-work/SKILL.md` | automatic | Playbooks | `skills/plan-work/SKILL.md` | `baseline-runtime` | routing/计划边界合同；无 outcome benchmark | 评估承重的顺序、迁移和范围决策是否改善结果；已确定计划不应重新触发规划 |
